...
import org.example.project.data.CreateCronRequest
import org.example.project.data.CronTaskApiItem
import org.example.project.data.UpdateCronRequest
...
class CronTaskViewModel : ViewModel() {
    ...
    fun showEdit(task: CronTaskApiItem) { _editingTask.value = task; _actionError.value = null }
    ...
    fun updateTask(id: Long, name: String, cronTime: String, keep: Int,
        ...
        viewModelScope.launch {
            ...
            val req = UpdateCronRequest(name, cronTime, keep, script, url, subType, targets)
